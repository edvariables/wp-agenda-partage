...
class AgendaPartage_DB_Update {
	...
	*/
	public static function update_db_1_0_22(){
		...
		if(AgendaPartage::get_option('agdpevent_tax_publication_newsletter_term_id')){
			AgendaPartage::update_option('newsletter_diffusion_term_id', AgendaPartage::get_option('agdpevent_tax_publication_newsletter_term_id'));
			AgendaPartage::update_option('agdpevent_tax_publication_newsletter_term_id', null);
		}
