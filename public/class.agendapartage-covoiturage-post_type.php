...
class AgendaPartage_Covoiturage_Post_type {
	...
	public static function get_all_cities($array_keys_field = 'term_id', $query_args = []){
		return AgendaPartage_Covoiturage::get_all_terms(AgendaPartage_Covoiturage::taxonomy_city, $array_keys_field, $query_args);
	}
	public static function get_all_diffusions($array_keys_field = 'term_id', $query_args = []){
		return AgendaPartage_Covoiturage::get_all_terms(AgendaPartage_Covoiturage::taxonomy_diffusion, $array_keys_field, $query_args);
	}
