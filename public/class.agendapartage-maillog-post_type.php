 ...
 */
class AgendaPartage_Maillog_Post_type {
	...
	public static function register_post_type() {
		...
		$args = array(
			...
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions' ),//, 'author', 'editor' see AgendaPartage_Admin_Maillog::init_PostType_Supports
			'taxonomies'            => array(  ),
			'hierarchical'          => false,
			'public'                => true,
			'show_ui'               => true,
		...
		register_post_type( AgendaPartage_Maillog::post_type, $args );
