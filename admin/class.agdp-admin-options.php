...
class Agdp_Admin_Options {
	...
	*/
	...
	private static function test_code(){
		$value = '
					<h3 class="comment-title">[ecopartage] [Les covoiturages à venir]</h3><p><message class="">Bonjour,</message></p>
<p>Voici les covoiturages à venir inscrits dans <a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturages/" rel="nofollow ugc">l’agenda partagé du Pays de Saint-Félicien</a> :</p>
<style>
.entry-content {
	font-family: arial;
}
...
} .aevs-email .covoiturage .dates {
	font-size: larger;
font-weight: bold;
} .aevs-email a-li a-li {
	margin-left: 1em;
padding-top: 2em;
}
.aevs-email div.titre, .aevs-email div.localisation, .aevs-email div.cov-cities {
	font-weight: bold;
}
.aevs-email span.cov-nb-places {
	padding-left: 1em;
}
.aevs-email i {
	font-style: normal;
...
<div class="aevs aevs-email">
<div class="cov-periodiques-link">Vous trouverez, plus bas,<span class="cov-periodiques"> 4 covoiturages périodiques</span>.</div>
<div class="a-ul">
<div class="a-li">
<div class="month-title tgt  active">du 10 au 16 juin 2024 <span class="nb-items">(1)</span></div>
<div class="a-ul" id="month-2024-24">
<div class="a-li">
<div class="covoiturage  ">
<div class="titre"><span class="cov-intention cov-intention-2">CHERCHE</span> <span class="cov-nb-places">1 place</span><br><span class="title-prep">Le</span> dimanche <span class="cov-date-jour-num">16</span> juin 2024 à 12h<br><span class="title-prep">de</span> <span class="cov-depart">Nozières</span><br><span class="title-prep">vers</span> <span class="cov-arrivee">Tain</span></div>
<div class="created-since">il y a 44 minutes</div>
</div>
<div>
<pre>Je cherche un covoiturage pour la gare de Tain à 12h40 ou à Lyon à la Part Dieu à 14h</pre>
<div>Organisé par : Léa</div>
<div class="cov-phone">Téléphone : 06 84 63 48 48</div>
<div class="footer">
<table>
<tbody>
<tr></tr>
...
<tr>
<td class="post-edit"><a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/cherche-1-place-tous-les-a-12h-de-nozieres-vers-tain/" rel="nofollow ugc">Afficher la page du covoiturage</a></td>
</tr>
</tbody>
</table>
</div>
...
<div class="a-li">
<div class="month-title cov-periodiques tgt active">Covoiturages périodiques <span class="nb-items">(4)</span></div>
<div class="a-ul">
<div class="a-li">
<div class="covoiturage  ">
<div class="titre"><span class="cov-intention cov-intention-1">PROPOSE</span> <span class="cov-nb-places">3 places</span><br>Tous les lundi -jeudi – vendredi à 7h45, retour à 16h30<br><span class="title-prep">de</span> <span class="cov-depart">Pailhares</span><br><span class="title-prep">vers</span> <span class="cov-arrivee">Annonay -Davezieux</span></div>
<div class="created-since">il y a 11 jours</div>
</div>
<div>
<pre>Heures adaptables , je passe par le col du marchand, Satillieu , saint Alban et je vais a cote de la Lombardiere</pre>
<div>Organisé par : LUCILE MOLLON</div>
<div class="cov-phone">Téléphone : 0782998389</div>
<div class="footer">
<table>
<tbody>
<tr>
<td class="post-edit"><a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/propose-3-places-tous-les-lundi-jeudi-vendredi-a-7h45-retour-a-16h30-de-pailhares-vers-annonay-davezieux/" rel="nofollow ugc">Afficher la page du covoiturage</a></td>
</tr>
</tbody>
</table>
</div>
...
<div class="a-li">
<div class="covoiturage  ">
<div class="titre"><span class="cov-intention cov-intention-1">PROPOSE</span> <span class="cov-nb-places">3 places</span><br>Tous les lundi au vendredi à 9h<br><span class="title-prep">de</span> <span class="cov-depart">Boucieu le roi</span><br><span class="title-prep">vers</span> <span class="cov-arrivee">Annonay</span></div>
<div class="created-since">il y a 2 mois</div>
</div>
<div>
<pre>Bonjour je travaille sur Annonay et je fais le trajet au moins 3 fois par semaine. 
Départ de Boucieu le Roi entre 09h et 09h15. 
Retour en fin de journée entre 18h00 et 19h30. 
Lorsque vous clavez besoin contactez moi pour savoir si je fais le trajet le jour dont vous avez besoin.
Je passe par Les Clots.
Au plaisir de covoiturer
Sandra</pre>
<div>Organisé par : Sandra De Campos</div>
<div class="cov-phone">Téléphone : <a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/propose-3-places-tous-les-lundi-au-vendredi-a-9h-de-boucieu-le-roi-vers-annonay/" rel="nofollow ugc">(masqué)</a></div>
<div class="footer">
<table>
<tbody>
<tr>
<td class="post-edit"><a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/propose-3-places-tous-les-lundi-au-vendredi-a-9h-de-boucieu-le-roi-vers-annonay/" rel="nofollow ugc">Afficher la page du covoiturage</a></td>
</tr>
</tbody>
</table>
</div>
...
<div class="a-li">
<div class="covoiturage  ">
<div class="titre"><span class="cov-intention cov-intention-1">PROPOSE</span> <span class="cov-nb-places">3 places</span><br>Tous les mercredis une semaine sur 2 à 14h<br><span class="title-prep">de</span> <span class="cov-depart">Saint Félicien</span><br><span class="title-prep">vers</span> <span class="cov-arrivee">Lyon</span></div>
<div class="created-since">il y a 3 mois</div>
</div>
<div>
<pre>Je vais à Lyon environ tous les 15 jours le mercredi et je reviens le jeudi matin.</pre>
<div>Organisé par : <a href="mailto:maria_sat5@yahoo.fr">maria_sat5@yahoo.fr</a></div>
<div class="cov-phone">Téléphone : 0683171576</div>
<div class="footer">
<table>
<tbody>
<tr>
<td class="post-edit"><a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/propose-3-places-tous-les-mercredis-une-semaine-sur-2-a-14h-de-saint-felicien-vers-lyon/" rel="nofollow ugc">Afficher la page du covoiturage</a></td>
</tr>
</tbody>
</table>
</div>
...
<div class="a-li">
<div class="covoiturage  ">
<div class="titre"><span class="cov-intention cov-intention-1">PROPOSE</span> <span class="cov-nb-places">4 places</span><br>Tous les mardis à 6h30, retour à 18h40<br><span class="title-prep">de</span> <span class="cov-depart">Saint-Félicien (Le Balayn)</span><br><span class="title-prep">vers</span> <span class="cov-arrivee">Annonay</span></div>
<div class="created-since">il y a 4 mois</div>
</div>
<div>
<div>Organisé par : Camille</div>
<div class="cov-phone">Téléphone : <a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/propose-4-places-tous-les-mardis-a-6h30-retour-a-18h40-de-saint-felicien-le-balayn-vers-annonay/" rel="nofollow ugc">(masqué)</a></div>
<div class="footer">
<table>
<tbody>
<tr>
<td class="post-edit"><a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturage/propose-4-places-tous-les-mardis-a-6h30-retour-a-18h40-de-saint-felicien-le-balayn-vers-annonay/" rel="nofollow ugc">Afficher la page du covoiturage</a></td>
</tr>
</tbody>
</table>
</div>
...
<hr>
<p>Consultez la suite des covoiturages sur <a href="https://pays-de-saint-felicien.agenda-partage.fr/covoiturages/" rel="nofollow ugc">https://pays-de-saint-felicien.agenda-partage.fr/covoiturages/</a></p>
<p>Pour vous désinscrire de cette lettre-info ou modifier la périodicité de votre abonnement, <a href="https://pays-de-saint-felicien.agenda-partage.fr/la-lettre-info/" rel="nofollow ugc">cliquez ici</a>.</p>
				';
		...
		if( strlen($value) > $max_len ){
			...
			// debug_log( __FUNCTION__ . ' value', $value, ' ' );
			// debug_log( __FUNCTION__ . ' end', $end, ' ' );
			...
			if( $pos === false )
				...
				if( $pos === false )
					...
					$value .= substr( $end, 0, $pos + 1 );
					$end = substr( $end, $pos + 1 );
					$value .= ' STOP STOP STOP STOP';
					debug_log( __FUNCTION__, $end, strlen($end) );
					foreach( ['p', 'table', 'div', 'pre', 'a', 'span' ] as $tag) {
						$pattern = sprintf('/<%s.+<\/%s>/', $tag, $tag, $tag);
						$end = preg_replace($pattern, '', $end );
						debug_log( $pattern . ' (' . strlen($end) . ')');
					}
					foreach( ['img', 'br' ] as $tag) {
		...
		if( $email_mode )
			$html .= sprintf('<pre>%s%s%s</pre>', $value, $end, $more );
		else
			$html .= sprintf('<pre>%s%s%s</pre>', htmlentities($value), $end, $more );
